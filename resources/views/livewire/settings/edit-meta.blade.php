        ...
        <div class="space-y-5 p-1">
            <div class="pb-4 border-b border-gray-200 dark:border-gray-700">
                <flux:heading size="lg">
                    ...
                    <span class="font-mono text-sm font-normal text-gray-500 ml-1">{{ $subjectKey }}</span>
                </flux:heading>
            ...
            <div>
                ...
                @if($iconSvg)
                    <div class="mb-2 flex items-center gap-3">
                        <span class="inline-flex items-center justify-center w-8 h-8 rounded border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-900"
